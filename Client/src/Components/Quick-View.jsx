              ...
              <div className="mb-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Rental price per unit, billed monthly
                  </div>
                </div>
            ...
            <TabsContent value="specifications" className="pt-4">
              <div className="space-y-2">
                {Object.entries(specifications).map(([key, value], index) => (
                  <div
                    key={index}
                    className="grid grid-cols-2 gap-2 py-2 border-b border-gray-100 last:border-0"
                  >
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      We offer free delivery for all rental items. Our team will
                      handle setup and installation.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Return or exchange your rental items with ease. Schedule a
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Optional damage protection available for peace of mind
